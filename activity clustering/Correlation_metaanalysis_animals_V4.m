% To be run after Cluster_analysis_pipeline code, performs additional
...
if isfield (FOV_analyzed.group_1,'Complete_on_response')
    
    if isfield (FOV_analyzed.group_1.Complete_on_response,'All_celltypes')
        
        if isfield(FOV_analyzed.group_1.Complete_on_response.All_celltypes,'Field0')
        ...
        if isfield(FOV_analyzed.group_1.Complete_on_response.All_celltypes,'Field1')
        ...
        if isfield(FOV_analyzed.group_1.Complete_on_response.All_celltypes,'Field2')
        ...
        if isfield(FOV_analyzed.group_1.Complete_on_response.All_celltypes,'Field3')
    ...
    if isfield (FOV_analyzed.group_1.Complete_on_response,'Celltype1')
        
        if isfield(FOV_analyzed.group_1.Complete_on_response.Celltype1,'Field0')
        ...
        if isfield(FOV_analyzed.group_1.Complete_on_response.Celltype1,'Field1')
        ...
        if isfield(FOV_analyzed.group_1.Complete_on_response.Celltype1,'Field2')
        ...
        if isfield(FOV_analyzed.group_1.Complete_on_response.Celltype1,'Field3')
    ...
    if isfield (FOV_analyzed.group_1.Complete_on_response,'Celltype0')
        
        if isfield(FOV_analyzed.group_1.Complete_on_response.Celltype0,'Field0')
        ...
        if isfield(FOV_analyzed.group_1.Complete_on_response.Celltype0,'Field1')
        ...
        if isfield(FOV_analyzed.group_1.Complete_on_response.Celltype0,'Field2')
        ...
        if isfield(FOV_analyzed.group_1.Complete_on_response.Celltype0,'Field3')
...
if isfield (FOV_analyzed.group_1,'Limited_on_response')
    
    if isfield (FOV_analyzed.group_1.Limited_on_response,'All_celltypes')
        
        if isfield(FOV_analyzed.group_1.Limited_on_response.All_celltypes,'Field0')
        ...
        if isfield(FOV_analyzed.group_1.Limited_on_response.All_celltypes,'Field1')
        ...
        if isfield(FOV_analyzed.group_1.Limited_on_response.All_celltypes,'Field2')
        ...
        if isfield(FOV_analyzed.group_1.Limited_on_response.All_celltypes,'Field3')
...
if isfield (FOV_analyzed.group_1,'Off_response')
        ...
        metadata.sounds_per_cluster(n) = length(Loaded_data.Results.(analysis_window).(Celltypes).Cluster_analysis.(Field).sound_clusters{n}.sounds_in_cluster);
                        ...
                        vocalization_counter = 0;
                            ...
                            for m = 1:metadata.sounds_per_cluster(n)
                                ...
                                elseif contains(Loaded_data.Results.(analysis_window).(Celltypes).Cluster_analysis.(Field).sound_clusters{n}.sounds_in_cluster{m},'vocalization')
                                    vocalization_counter = vocalization_counter +1;
                                else
                                    animal_sound_counter = animal_sound_counter +1;
                                end
                                
                                if contains(Loaded_data.Results.(analysis_window).(Celltypes).Cluster_analysis.(Field).sound_clusters{n}.sounds_in_cluster{1},'PT_50dB') ||  contains(Loaded_data.Results.(analysis_window).(Celltypes).Cluster_analysis.(Field).sound_clusters{n}.sounds_in_cluster{1},'AM_20Hz') || contains(Loaded_data.Results.(analysis_window).(Celltypes).Cluster_analysis.(Field).sound_clusters{n}.sounds_in_cluster{1},'AM_40Hz')
                                freq(m) = (str2num(Loaded_data.Results.(analysis_window).(Celltypes).Cluster_analysis.(Field).sound_clusters{n}.sounds_in_cluster{m}(9:end)))/1000;

                                freq(m) = (log2(freq(m)))-2;
                                end

                            end
                            
                            metadata.max_cluster_dominance(n) = (max(horzcat(PT_counter,AM_20Hz_counter,AM_40Hz_counter,animal_sound_counter,vocalization_counter)))/metadata.sounds_per_cluster(n);
                            sound_index = find((horzcat(PT_counter,AM_20Hz_counter,AM_40Hz_counter,animal_sound_counter,vocalization_counter)) == (max(horzcat(PT_counter,AM_20Hz_counter,AM_40Hz_counter,animal_sound_counter,vocalization_counter))));
                            ...
                            elseif sound_index  == 5
                            metadata.max_cluster_dominance_sound{n} = 'mouse_vocalization_dummies';
                            else
                            metadata.max_cluster_dominance_sound{n} = 'tied';   
                            end
                            
                                
                            if PT_counter > metadata.sounds_per_cluster(n)/1.3333
                                 metadata.Strong_Cluster_dominance{n} = 'PT';
                            elseif AM_20Hz_counter > metadata.sounds_per_cluster(n)/1.3333
                                metadata.Strong_Cluster_dominance{n} = 'AM_20Hz';
                            elseif AM_40Hz_counter > metadata.sounds_per_cluster(n)/1.3333
                                metadata.Strong_Cluster_dominance{n} = 'AM_40Hz';
                            elseif animal_sound_counter > metadata.sounds_per_cluster(n)/1.3333
                                metadata.Strong_Cluster_dominance{n} = 'Animal_sounds';
                            elseif vocalization_counter > metadata.sounds_per_cluster(n)/1.3333
                                metadata.Strong_Cluster_dominance{n} = 'mouse_vocalization_dummies';
                            else
                                metadata.Strong_Cluster_dominance{n} = 'mixed';
                            end
                            
                            if contains(Loaded_data.Results.(analysis_window).(Celltypes).Cluster_analysis.(Field).sound_clusters{n}.sounds_in_cluster{1},'PT_50dB') ||  contains(Loaded_data.Results.(analysis_window).(Celltypes).Cluster_analysis.(Field).sound_clusters{n}.sounds_in_cluster{1},'AM_20Hz') || contains(Loaded_data.Results.(analysis_window).(Celltypes).Cluster_analysis.(Field).sound_clusters{n}.sounds_in_cluster{1},'AM_40Hz')
                            metadata.Sound_cluster_freq_IQR(n) = iqr(freq);
                            end
...
if kstest((data1.fraction_of_clustered_sounds-mean(data1.fraction_of_clustered_sounds))/std(data1.fraction_of_clustered_sounds)) ==0 && kstest((data2.fraction_of_clustered_sounds-mean(data2.fraction_of_clustered_sounds))/std(data2.fraction_of_clustered_sounds))  ==0
    [h,p] = ttest2(data1.fraction_of_clustered_sounds,data2.fraction_of_clustered_sounds);
    stats.fraction_of_clustered_sounds.p_value = p;
    stats.fraction_of_clustered_sounds.test_type = 'ttest';
else
    p = ranksum(data1.fraction_of_clustered_sounds,data2.fraction_of_clustered_sounds);
    stats.fraction_of_clustered_sounds.p_value = p;
    stats.fraction_of_clustered_sounds.test_type = 'ranksum';
end
...
if kstest((data1.neurons_per_FOV-mean(data1.neurons_per_FOV))/std(data1.neurons_per_FOV)) ==0 && kstest((data2.neurons_per_FOV-mean(data2.neurons_per_FOV))/std(data2.neurons_per_FOV))  ==0
    [h,p] = ttest2(data1.neurons_per_FOV,data2.neurons_per_FOV);
    stats.neurons_per_FOV.p_value = p;
    stats.neurons_per_FOV.test_type = 'ttest';
else
    p = ranksum(data1.neurons_per_FOV,data2.neurons_per_FOV);
    stats.neurons_per_FOV.p_value = p;
    stats.neurons_per_FOV.test_type = 'ranksum';
end
...
if  kstest((data1.number_of_sound_clusters-mean(data1.number_of_sound_clusters))/std(data1.number_of_sound_clusters)) ==0 && kstest((data2.number_of_sound_clusters-mean(data2.number_of_sound_clusters))/std(data2.number_of_sound_clusters))  ==0
    [h,p] = ttest2(data1.number_of_sound_clusters,data2.number_of_sound_clusters);
    stats.number_of_sound_clusters.p_value = p;
    stats.number_of_sound_clusters.test_type = 'ttest';
else
    p = ranksum(data1.number_of_sound_clusters,data2.number_of_sound_clusters);
    stats.number_of_sound_clusters.p_value = p;
    stats.number_of_sound_clusters.test_type = 'ranksum';
end
...
if kstest((data1.overall_sound_correlations-mean(data1.overall_sound_correlations))/std(data1.overall_sound_correlations)) ==0 && kstest((data2.overall_sound_correlations-mean(data2.overall_sound_correlations))/std(data2.overall_sound_correlations))  ==0
    [h,p] = ttest2(data1.overall_sound_correlations,data2.overall_sound_correlations);
    stats.overall_sound_correlations.p_value = p;
    stats.overall_sound_correlations.test_type = 'ttest';
else
    p = ranksum(data1.overall_sound_correlations,data2.overall_sound_correlations);
    stats.overall_sound_correlations.p_value = p;
    stats.overall_sound_correlations.test_type = 'ranksum';
end
...
if kstest((data1.overall_sound_reliabilities-mean(data1.overall_sound_reliabilities))/std(data1.overall_sound_reliabilities)) ==0 && kstest((data2.overall_sound_reliabilities-mean(data2.overall_sound_reliabilities))/std(data2.overall_sound_reliabilities))  ==0
    [h,p] = ttest2(data1.overall_sound_reliabilities,data2.overall_sound_reliabilities);
    stats.overall_sound_reliabilities.p_value = p;
    stats.overall_sound_reliabilities.test_type = 'ttest';
else
    p = ranksum(data1.overall_sound_reliabilities,data2.overall_sound_reliabilities);
    stats.overall_sound_reliabilities.p_value = p;
    stats.overall_sound_reliabilities.test_type = 'ranksum';
end
...
stats.Cluster_dominance.set1.mouse_vocalization_dummies = 0;
...
stats.Cluster_dominance.set2.mouse_vocalization_dummies = 0;
...
for i=1:length(data1.Cluster_dominance)
                   ...
                   if contains(data1.Cluster_dominance{i}, 'PT')
                    ...
                    elseif contains(data1.Cluster_dominance{i}, 'mouse_vocalization_dummies' )
                        
                        stats.Cluster_dominance.set1.mouse_vocalization_dummies = stats.Cluster_dominance.set1.mouse_vocalization_dummies +1 ;
...
for i=1:length(data2.Cluster_dominance)
                   ...
                   if contains(data2.Cluster_dominance{i}, 'PT')
                    ...
                    elseif contains(data2.Cluster_dominance{i}, 'Animal_sounds') % categorize as complex sounds
                        
                        stats.Cluster_dominance.set2.Animal_sounds = stats.Cluster_dominance.set2.Animal_sounds +1 ;
                       
                    elseif contains(data2.Cluster_dominance{i}, 'mouse_vocalization_dummies' ) % categorize as complex sounds
                        
                        stats.Cluster_dominance.set2.mouse_vocalization_dummies = stats.Cluster_dominance.set2.mouse_vocalization_dummies +1 ;
                        
                   elseif contains(data2.Cluster_dominance{i}, 'mixed' ) % categorize as complex sounds
...
stats.Strong_Cluster_dominance.set1.mouse_vocalization_dummies = 0;
...
stats.Strong_Cluster_dominance.set2.mouse_vocalization_dummies = 0;
...
for i=1:length(data1.Strong_Cluster_dominance)
                   ...
                   if contains(data1.Strong_Cluster_dominance{i}, 'PT')
                    ...
                    elseif contains(data1.Strong_Cluster_dominance{i}, 'mouse_vocalization_dummies' )
                        
                        stats.Strong_Cluster_dominance.set1.mouse_vocalization_dummies = stats.Strong_Cluster_dominance.set1.mouse_vocalization_dummies +1 ;
...
for i=1:length(data2.Strong_Cluster_dominance)
                   ...
                   if contains(data2.Strong_Cluster_dominance{i}, 'PT')
                    ...
                    elseif contains(data2.Strong_Cluster_dominance{i}, 'mouse_vocalization_dummies' )
                        
                        stats.Strong_Cluster_dominance.set2.mouse_vocalization_dummies = stats.Strong_Cluster_dominance.set2.mouse_vocalization_dummies +1 ;
...
stats.max_cluster_dominance_sound.set1.mouse_vocalization_dummies = 0;
...
stats.max_cluster_dominance_sound.set2.mouse_vocalization_dummies = 0;
...
for i=1:length(data1.max_cluster_dominance_sound)
                   ...
                   if contains(data1.max_cluster_dominance_sound{i}, 'PT')
                    ...
                    elseif contains(data1.max_cluster_dominance_sound{i}, 'mouse_vocalization_dummies' )
                        
                        stats.max_cluster_dominance_sound.set1.mouse_vocalization_dummies = stats.max_cluster_dominance_sound.set1.mouse_vocalization_dummies +1 ;
...
for i=1:length(data2.max_cluster_dominance_sound)
                   ...
                   if contains(data2.max_cluster_dominance_sound{i}, 'PT')
                    ...
                    elseif contains(data2.max_cluster_dominance_sound{i}, 'mouse_vocalization_dummies' )
                        
                        stats.max_cluster_dominance_sound.set2.mouse_vocalization_dummies = stats.max_cluster_dominance_sound.set2.mouse_vocalization_dummies +1 ;
